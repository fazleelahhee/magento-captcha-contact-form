 ...
 */
class Bondmedia_Bondcaptcha_BondmediaController extends Mage_Core_Controller_Front_Action
{
	/** Width of the image */
	public $width  = 200;
	...
	public function captchaAction() {
	    $this->resourcesPath = Mage::getBaseDir('skin').'/frontend/default/default/bondcaptcha';
		$this->CreateImage();
	}
	...
	protected function CreateImage() {
        ...
        Mage::getSingleton('core/session')->setBondCaptcha($text);
